...
APlayerCharacter::APlayerCharacter() : 
	...
	MouseHipTurnRate(0.8f), MouseHipLookUpRate(0.8f), MouseAimingTurnRate(0.8f), MouseAimingLookUpRate(0.8f),
...
{
	const USkeletalMeshSocket* Fire_Socket = GetMesh()->GetSocketByName("Fire_Socket");
	if (Fire_Socket)
	{
